...
def main():
    ...
    app.write_rows(wb, "低于成本价", sort_rows(below_cost), ["店铺", "SKC", "商家编码", "货品名称", "货品规格", "货品分类名称", "申报价", "成本价", "负责人", "7天销量", "30天销量", "源SKU", "源文件", "源行"])
    app.write_rows(wb, "低于批发价80%", sort_rows(below_wholesale), ["店铺", "SKC", "商家编码", "货品名称", "货品规格", "货品分类名称", "申报价", "成本价", "批发价", "批发价80%", "负责人", "7天销量", "30天销量", "源SKU", "源文件", "源行"])
