...
contextBridge.exposeInMainWorld("dailyOps", {
  ...
  assetOverview: (payload) => ipcRenderer.invoke("api:asset-overview", payload || {}),
  exportAssetArchive: (payload) => ipcRenderer.invoke("api:export-asset-archive", payload || {}),
  importAssetArchive: (payload) => ipcRenderer.invoke("api:import-asset-archive", payload || {}),
  importMatrix: (payload) => ipcRenderer.invoke("api:import-matrix", payload || {}),
  erpSync: (payload) => ipcRenderer.invoke("api:erp-sync", payload || {}),
  bargainClearance: (payload) => ipcRenderer.invoke("api:bargain-clearance", payload || {}),
  rebuildBargainClearance: (payload) => ipcRenderer.invoke("api:bargain-rebuild-clearance", payload || {}),
  bargainLookup: (payload) => ipcRenderer.invoke("api:bargain-lookup", payload || {}),
  bargainSubmit: (payload) => ipcRenderer.invoke("api:bargain-submit", payload || {}),
  bargainReview: (payload) => ipcRenderer.invoke("api:bargain-review", payload || {}),
  bargainResubmit: (payload) => ipcRenderer.invoke("api:bargain-resubmit", payload || {}),
  bargainHistory: (payload) => ipcRenderer.invoke("api:bargain-history", payload || {}),
  bargainLowPriceTrace: (payload) => ipcRenderer.invoke("api:bargain-low-price-trace", payload || {}),
  bargainIgnoreLowPrice: (payload) => ipcRenderer.invoke("api:bargain-ignore-low-price", payload || {}),
