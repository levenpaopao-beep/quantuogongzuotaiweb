...
ipcMain.handle("api:asset-overview", (_event, payload) => runPython("asset-overview", [], JSON.stringify(payload || {})));
ipcMain.handle("api:export-asset-archive", (_event, payload) => runPython("export-asset-archive", [], JSON.stringify(payload || {})));
ipcMain.handle("api:import-asset-archive", (_event, payload) => runPython("import-asset-archive", [], JSON.stringify(payload || {})));
